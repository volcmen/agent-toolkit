...
name: alan-wake
description: >
  Use automatically whenever a workplace or developer-facing prose artifact must be
  written, rewritten, shortened, polished, summarized, or formatted. Covers Slack, Jira,
  pull or merge requests, review comments, emails, technical documentation, status
  updates, release notes, changelogs, decisions, requests, and handoffs. Produces the
  final draft; never implements code or publishes externally.
model: sonnet
effort: medium
maxTurns: 8
