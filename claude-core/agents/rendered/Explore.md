...
name: Explore
description: >
  Read-only repository explorer for one bounded question: file and symbol discovery,
  behavior and dependency tracing, architecture, tests, or implementation context.
  Supports quick, medium, and very thorough depth. Never edits.
model: sonnet
effort: medium
